  ...
  return (
    <div className={cn(styles['invoice__table'], 'mx-auto')}>
      ...
      <div className="mb-3 px-5 py-3 col-12">
        ...
        {offCode != '' && (
          // <span className="color-green-1 text-2 d-flex align-items-center justify-content-center">
          //   <SuccessIcon className="ms-1" />
          //   30
          //   درصد تخفیف روی فاکتور شما با موفقیت اعمال گردید
          // </span>
