import { PassengersCount, PriceDetail } from 'services/train/tickets/priceDetail/interface';
...
const TicketDetailPassenger = ({ price, count }: TicketDetailPassengerProps) => {
  return (
    <>
      <>
        {price.tariff == 'TARIFF_ADULT' && count.adult != '0' && (
          <div className="d-flex justify-content-between  align-items-center my-2">
            ...
            <div dir="rtl" className="d-flex align-items-center">
              <span className="color-tertiary text-weight-bold text-3 ms-1 ">x {count.adult}</span>
        ...
        {price.tariff == 'TARIFF_CHILD' && count.child != '0' && (
          <div className="d-flex justify-content-between  align-items-center my-2">
            <div className="color-grey-1" dir="rtl">
            ...
            <div dir="rtl" className="d-flex align-items-center">
              <span className="color-tertiary text-weight-bold text-3 ms-1">x {count.child}</span>
              <span className="color-grey-1">
                {Number(price.price).toLocaleString()} <span className="text-2">ریال </span>
              </span>
            </div>
        ...
        {price.tariff == 'TARIFF_INFANT' && count.infant != '0' && (
          <div className="d-flex justify-content-between  align-items-center my-2">
            <div className="color-grey-1" dir="rtl">
            ...
            <div dir="rtl" className="d-flex align-items-center">
              <span className="color-tertiary text-weight-bold text-3 ms-1">x {count.infant}</span>
              <span className="color-grey-1">
                {Number(price.price).toLocaleString()} <span className="text-2">ریال </span>
              </span>
            </div>
...
export default TicketDetailPassenger;
