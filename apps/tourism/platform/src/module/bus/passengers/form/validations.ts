...
export const validations: Record<string, UseControllerProps['rules']> = {
  LatinFirstName: {
  ...
  FirstName: {
    ...
    pattern: { value: /^[\u0600-\u06FF\s]+$/, message: 'نام را فارسی وارد کنید' },
  },
  LastName: {
  ...
  PhoneNumber: {
    ...
    validate: (value: string) => isPhoneNumberValid(value) || 'شماره موبایل صحیح نمی باشد',
  },
};
